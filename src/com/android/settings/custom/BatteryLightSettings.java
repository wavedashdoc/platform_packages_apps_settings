...
public class BatteryLightSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getResources().getBoolean(
            ...
            mBatteryLightEnabled.setChecked(Settings.System.getIntForUser(resolver,
                            Settings.System.BATTERY_LIGHT_ENABLED, 0, UserHandle.USER_CURRENT) == 1);
        ...
        if (getResources().getBoolean(com.android.internal.R.bool.config_multiColorBatteryLed)) {
            ...
            color = Settings.System.getIntForUser(resolver,
                    Settings.System.BATTERY_LIGHT_MEDIUM_COLOR, 0xFFFFA500,
                            UserHandle.USER_CURRENT);
